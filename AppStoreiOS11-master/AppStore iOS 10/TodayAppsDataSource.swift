...
//        return [FeaturedAppCardCell.self, FeaturedAppCardCell.self,FeaturedAppCardCell.self, FeaturedAppCellBottomApp.self,]
    ...
    static var dummyData : [TodayArticle] = {
      ...
      //  let app4 = App(appName: "Aura", appDesc: "Edit and Share your photos", appID: 4, appCategory: "Social Networking", appPrice: 0, appStory:"123", appPhoto: "dev_solutions_card", screenShots: [""])
        let todayArticle4 = TodayArticle(app: nil, smallTitle: "GET STARTED", bigTitle: "Aura".uppercased(), briefDescription: "", article: "123", photo: "air_plane", hasApp: false, withBottomApp: false)
        
        let todayArticle1 = TodayArticle(app: app1, smallTitle: "", bigTitle: "Brand".uppercased(), briefDescription: "", article: "123", photo: "architexture", hasApp: true, withBottomApp: false)

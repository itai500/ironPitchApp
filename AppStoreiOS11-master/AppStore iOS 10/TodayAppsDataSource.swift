...
class TodayAppsDataSource: Datasource {
    ...
    static var dummyData : [TodayArticle] = {
        ...
        let todayArticle2 = TodayArticle(app: app1, smallTitle: "", bigTitle: "Brand" .uppercased(), briefDescription: "", article: "123", photo: "architexture", hasApp: true, withBottomApp: false)
